...
OaksLabChoseStarterScript:
	; the player always picks a Regigigas, so the ball the rival walks to
...
; All three balls contain a Regigigas for the player. The rival still takes
...
OaksLabShowPokeBallPokemonScript:
	...
	ld c, 10
	call DelayFrames
	; every ball holds a Regigigas
	ld hl, OaksLabYouWantRegigigasText
	; fallthrough
...
OaksLabYouWantRegigigasText:
	text_far _OaksLabYouWantRegigigasText
	text_end
